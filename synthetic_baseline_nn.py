...
train_data, other = torch.utils.data.random_split(SyntheticDataset(), [0.7,0.3])#, generator=seed)
...
for e in range(num_epochs):
    ...
    np.save("results/synthetic_baseline_train_loss.npy", train_losses)
    np.save("results/synthetic_baseline_val_loss.npy", val_losses)
