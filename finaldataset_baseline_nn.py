...
from dataloaders import SyntheticDataset, YahooDataset, finalDataset
...
train_data, other = torch.utils.data.random_split(finalDataset(), [0.7,0.3])#, generator=seed)
...
for e in range(num_epochs):
    ...
    np.save("results/finaldataset_baseline_train_loss.npy", train_losses)
    np.save("results/finaldataset_val_loss.npy", val_losses)
